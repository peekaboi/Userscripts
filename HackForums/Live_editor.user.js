...
var settings = {
    ...
    customButtons: GM_getValue("customButtons", "bold,italic,underline,strike,hr,|,img,video,skype,ig,link,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,emotes,quote,code,pmme,spoiler,removeformat | ,extras"),
...
var wbbOpt = {
    ...
    allButtons: {
        ...
        extras: {
            type: 'select',
            title: 'Extras',
            options: 'extra_memegen,extra_random'
        },
        extra_memegen: {
            title: "Meme Generator",
            cmd: function() {
                window.open('https://imgur.com/memegen', '_blank');
            }
        },extra_random: {
            title: "Random.org",
            cmd: function() {
                window.open('https://random.org', '_blank');
            }
        },
        emotes: {
            type: 'select',
